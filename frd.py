...
def importdata():
    ...
    text.insert(END,"Labelled class Information for Positive: "+str(positive_df['labeled_class'].value_counts())+"\n")
...
font = ('times', 16, 'bold')
title = Label(main, text='E-Commerce with Price Comparison, Price Alert and Fake Review Detection')
...
gf = Button(main, text="                   Accuracy ", command=graph)
gf.place(x=700,y=500)
gf.config(font=font1)

pp =Button(main, text="predict", command=predict)
pp.place(x=700,y=500)
